    ...
    sysfs_write(CPUQUIET_THERMAL_CPUS, normal_max_cpus);
     ...
     if (!on) {
		...
		sysfs_write(RQBALANCE_DOWN_THRESHOLD, low_down);
         ...
         ALOGE("Setting normal power mode");
